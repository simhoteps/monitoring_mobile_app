...
import AutomationHostsTable from "./components/AutomationHostsTable";

const AutomationHosts = () => {
  ...
  const unvirtualizationList = external.hosts.filter(
    (item: { os: string }) => item.os !== "Virtualization"
  );
  return (
    <View
      style={{
    ...
    >
      <View style={styles.titleContainer}>
        <View>
          ...
          >
            Total: {unvirtualizationList ? unvirtualizationList.length : 0}
          </Text>
        </View>
        <CustomerView />
      </View>
      {isError ? (
      ...
      ) : unvirtualizationList && unvirtualizationList.length === 0 ? (
        ...
        <View style={{ flex: 1, marginBottom: 80 }}>
          {/* begin:: Tablo */}
          <AutomationHostsTable datas={unvirtualizationList} />
          {/* end:: Tablo */}
          {/* begin:: Pagination */}
          <NumberPagination
...
export default AutomationHosts;
